-- =============================================================================
-- PMO SOLUTIONS — Esquema de Base de Datos MySQL v1.0 (Baseline Histórico)
-- Versión: 1.0 (Baseline para actualizaciones secuenciales)
-- Motor: InnoDB | Codificación: utf8mb4_unicode_ci
--
-- GUÍA DE USO:
--   * INSTALACIONES NUEVAS: NO ejecutar este archivo. Ejecutar directamente `backend/schema_v2.sql`.
--   * ACTUALIZACIONES / PRUEBAS DE MIGRACIÓN: Este archivo representa el estado base v1.0.
--     Para actualizar a v2.0, aplicar en orden:
--       1. `backend/migrations/001_add_report_access_token_hash.sql`
--       2. `backend/migrations/002_add_idempotency_and_outbox.sql`
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. TABLA: reclamaciones (Libro de Reclamaciones Virtual - v1.0)
...
-- -----------------------------------------------------------------------------
-- 2. TABLA: contactos (Mensajes del Formulario de Contacto - v1.0)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 3. TABLA: evaluaciones_habilidades_blandas (v1.0 sin report_access_token_hash)
-- -----------------------------------------------------------------------------
