...
class AuthTest {
    ...
    private function testSessionManagementAndRBAC(): void {
        ...
        $deniedOutput = shell_exec($phpBin . ' -r "require \'app/Core/Autoloader.php\'; App\\Core\\Autoloader::register(); App\\Core\\Security::requireRole(\'admin\');" 2>&1');
        ...
        $authDeniedOutput = shell_exec($phpBin . ' -r "require \'app/Core/Autoloader.php\'; App\\Core\\Autoloader::register(); App\\Core\\Security::requireAuthentication();" 2>&1');
